            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold font-poppins text-white">
                  ...
                  <span className="text-primary">NXY Markets</span>?
                </h2>

                <p className="text-lg text-white text-opacity-80 max-w-lg">
                  Download our mobile app now and join thousands of successful
                  traders worldwide. Experience the future of forex trading.
                </p>
                ...
                <div className="pt-4">
                  ...
                  >
                    ...
                    <span className="border-blac">Download Application</span>
                  </a>
                </div>
                  ...
                  <div className="flex items-center">
                    <div className="flex -space-x-2">
                      {[1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className="w-10 h-10 rounded-full bg-gray-700 border-2 border-gray-900 flex items-center justify-center text-white font-bold"
                        >
