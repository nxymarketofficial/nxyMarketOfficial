...
export default function Footer() {
  return (
    <footer className="pt-16 pb-8 bg-secondary text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#app" className="opacity-70 hover:opacity-100 transition-opacity">Mobile App</a></li>
              <li><a href="#social" className="opacity-70 hover:opacity-100 transition-opacity">Community</a></li>
              <li><a href="#download" className="opacity-70 hover:opacity-100 transition-opacity">Download</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="opacity-70 hover:opacity-100 transition-opacity">Risk Disclosure</a></li>
              <li><a href="#" className="opacity-70 hover:opacity-100 transition-opacity">AML Policy</a></li>
            </ul>
          </div>
