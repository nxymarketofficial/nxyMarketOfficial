  ...
  const socialChannels: SocialChannel[] = [
    {
      ...
      description: "Get instant market updates, trading signals, and expert analysis directly on Telegram.",
    ...
    },
    {
      ...
      title: "Instagram",
      description: "Follow our Instagram for educational content, success stories, and community highlights.",
    ...
    },
    {
      ...
      description: "Watch in-depth tutorials, market analysis, and trading strategies on our YouTube channel.",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {socialChannels.map((channel, index) => (
              ...
              >
                <div className={`w-16 h-16 ${channel.bgColor} bg-opacity-20 rounded-full flex items-center justify-center mb-6 mx-auto`}>
